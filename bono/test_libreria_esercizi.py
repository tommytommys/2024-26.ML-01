from bono import libreria_esercizi
import pytest
...
def test_E1_Triangoli_area():
    ...
    with pytest.raises(ValueError, match=r"Il triangolo non è valido"):
...
def test_E1_Triangoli_perimetro():
    ...
    with pytest.raises(ValueError, match=r"Il triangolo non è valido"):    
        libreria_esercizi.E1_Triangoli_perimetro([10, 10, 100]) == 120
    with pytest.raises(ValueError, match=r"Il triangolo non è valido"):
        libreria_esercizi.E1_Triangoli_perimetro([7, 2, 10]) == 19
    assert libreria_esercizi.E1_Triangoli_perimetro([15, 7, 10]) == 32
    assert libreria_esercizi.E1_Triangoli_perimetro([7, 7, 10]) == 24
    assert libreria_esercizi.E1_Triangoli_perimetro([7, 7, 7]) == 21


def test_E1_Triangoli_isValidTrinagolo():
    assert libreria_esercizi.E1_Triangoli_isValidTrinagolo(7, 7, 10) == True
    assert libreria_esercizi.E1_Triangoli_isValidTrinagolo(10, 10, 100) == False
    assert libreria_esercizi.E1_Triangoli_isValidTrinagolo(7, 2, 10) == False
    assert libreria_esercizi.E1_Triangoli_isValidTrinagolo(15, 7, 10) == True
