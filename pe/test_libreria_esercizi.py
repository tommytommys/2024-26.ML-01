from pe import libreria_esercizi
import pytest
...
def test_E1_Triangoli_area():
    ...
    with pytest.raises(ValueError, match=r"Perimetro non valido, i lati 10, 10 e 100 non possono fare un perimetro"):
        assert libreria_esercizi.E1_Triangoli_area([10, 10, 100])
    with pytest.raises(ValueError, match=r"Perimetro non valido, i lati 7, 2 e 10 non possono fare un perimetro"):
