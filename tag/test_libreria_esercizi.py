from tag import libreria_esercizi
import pytest
...
def test_E1_Triangoli_area():
    ...
    # TODO assert su presenza di 'math domain error' --> il todo rimane colorato perché segnala qualcosa in programma da fare
